/*********************************************************************************************************//**
 * @file    BMP73T104_HT32/example_dcMotorRun/ht32_board_config.h
 * @version V1.0.1
 * @date    2024-08-06
...
#define BMP73T104_WIRE                              (0)
/* BMP73T104 INT PIN  --------------------------------------------------------------------------------------*/
#define   BMP73T104_INTPIN_GPIO        STRCAT2(P,            B)
#define   BMP73T104_INTPIN_GPIO_ID     STRCAT2(GPIO_P,       B)
