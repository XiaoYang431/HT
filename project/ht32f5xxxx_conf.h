...
/*
//<q> Enable Stack Usage Analysis 
//    <i> Enable Stack Usage Analysis feature. This feature is only applicable to the Keil MDK-ARM.
//    <i> Please call the "StackUsageAnalysisInit()" function in the begin of the "main()".
//    <i> Under Keil Debug mode, tick "View > Watch Window > HT32 Stack Usage Analysis" to show the stack usage information.
