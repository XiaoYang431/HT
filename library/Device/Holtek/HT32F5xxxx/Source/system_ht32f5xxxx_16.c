/**************************************************************************//**
 * @file    library/Device/Holtek/HT32F5xxxx/Source/system_ht32f5xxxx_16.c
...
//        <o5>  PLL Clock Source Divider (SRC_DIV)
//                <0=> 1
//                <1=> 2
...
#define PLL_NF2_DIV       (20)    /*!< 1~32: DIV1~DIV32                                                     */
#define PLL_NO2_DIV       (0)     /*!< 0: DIV1,     1: DIV2,   2: DIV4,   3: DIV8                           */
#define HCLK_SRC          (1)     /*!< 0: PLL,      1: PLL,    2: HSE,    3: HSI                7: LSI      */
#define HCLK_DIV          (0)     /*!< 0: DIV1,     1: DIV2,   2: DIV4,   3: DIV8,   4: DIV16,  5: DIV32    */
#define WAIT_STATE        (9)     /*!< 0: WS = 0,   1: WS = 1, 2: WS = 2, 3: WS = 3, 9: AUTO                */
...
void SystemInit(void)
{
  ...
  #if (DEINIT_ENABLE == 1)
  /* De-init the setting                                                                                    */
  HT_CKCU->AHBCCR &= ~(0x1 << 11);                              /* disable IP who may use PLL as source     */
