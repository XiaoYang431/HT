...
void CKCU_DeInit(void)
{
  ...
  #endif
  #if (!LIBCFG_CKCU_NO_AUTO_TRIM)
  HT_CKCU->HSICR = 0;                            /* Reset value of HSICR                                    */
  #endif
  #if ((!LIBCFG_CKCU_NO_APB_PRESCALER) && (LIBCFG_PWM0 || LIBCFG_PWM1 || LIBCFG_MIDI || LIBCFG_DAC0 || LIBCFG_DAC1 || LIBCFG_DACDUAL16 || LIBCFG_LCD || LIBCFG_LEDC || LIBCFG_TKEY))
  HT_CKCU->APBPCSR2 = 0;                         /* Reset value of APBPCSR2                                 */
  #endif
  #if (LIBCFG_CKCU_HSIRDYCR)
  HT_CKCU->HSIRDYCR = 0;                         /* Reset value of HSIRDYCR                                 */
  #endif
  #if (!LIBCFG_CKCU_NO_LPCR)
...
#if (LIBCFG_CKCU_LCD_SRC)
/*********************************************************************************************************//**
 * @brief Configure LCD clock source.
...
#if (LIBCFG_CKCU_HSIRDYCR)
/*********************************************************************************************************//**
 * @brief Set HSI Ready Counter Value.
