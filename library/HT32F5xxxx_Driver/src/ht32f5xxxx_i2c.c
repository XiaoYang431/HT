...
/* I2C Device Address 0 and Device Address 1 mask                                                           */
#define ADDR_DEVADDR0_SET        ((u32)0x00008000)
#define ADDR_DEVADDR0_RESET      ((u32)0xFFFF7FFF)
...
void I2C_Init(HT_I2C_TypeDef* I2Cx, I2C_InitTypeDef* I2C_InitStruct)
{
  ...
  I2Cx->CR = (I2Cx->CR & 0xFFFFFFFA) | I2C_InitStruct->I2C_GeneralCall | I2C_InitStruct->I2C_Acknowledge;
  #else
  ...
  I2Cx->ADDR = (I2Cx->ADDR & 0xFFFF0000) | (ADDR_DEVADDR0_SET | (I2C_InitStruct->I2C_OwnAddress));
  #else
...
void I2C_SetOwnAddress(HT_I2C_TypeDef* I2Cx, I2C_AddressTypeDef I2C_Address)
{
  ...
  #if (LIBCFG_I2C_TWO_DEV_ADDR)
  I2Cx->ADDR = (I2Cx->ADDR & 0xFFFFFF80) | (ADDR_DEVADDR0_SET | I2C_Address);
  #else
...
#if (LIBCFG_I2C_TWO_DEV_ADDR)
/*********************************************************************************************************//**
 * @brief Configure own address 1 of the specified I2C.
 * @param I2Cx: where I2Cx is the selected I2C from the I2C peripherals.
 * @param I2C_Address: specify own address 1 of I2C.
 * @retval None
 ************************************************************************************************************/
void I2C_SetOwnAddress1(HT_I2C_TypeDef* I2Cx, I2C_AddressTypeDef I2C_Address)
{
  ...
  I2Cx->ADDR = (I2Cx->ADDR & 0xFF80FFFF) | (ADDR_DEVADDR1_SET | (I2C_Address << 16));
}

/*********************************************************************************************************//**
 * @brief Enable or Disable I2C own address.
 * @param I2Cx: where I2Cx is the selected I2C from the I2C peripherals.
 * @param Address: specify the ADDR number.
...
{
  u32 value = ADDR_DEVADDR0_SET;

  /* Check the parameters                                                                                   */
  Assert_Param(IS_I2C(I2Cx));
  Assert_Param(IS_I2C_ADDR(Address));
  Assert_Param(IS_CONTROL_STATUS(NewState));

  if (Address == I2C_DEV_ADDR_1)
  {
    value = value << 16;
  }
