...
#ifndef __HT32F5XXXX_USBDCHK_H
#define __HT32F5XXXX_USBDCHK_H
...
/*----------------------------------------------------------------------------------------------------------*/
#if (_EP8_ENABLE == 1)
  #if (_EP8_TYPR == EP_TYPE_BULK)
    #if (_EP8LEN != 8 && _EP8LEN != 16 && _EP8LEN != 32 && _EP8LEN != 64)
      #error "USB Buffer Length (EPLEN) of Endpoint8 must be 8, 16, 32, or 64 bytes under Bulk transfer."
    #endif
  #endif
  #if (_EP8LEN > 64)
    #error "USB Buffer Length (EPLEN) of Endpoint8 must be less than 64 bytes."
  #endif
  #if (_EP8LEN == 0)
    #error "USB Buffer Length (EPLEN) of Endpoint8 cannot be 0 byte."
  #endif
  #if ((_EP8LEN & 0x3) != 0x0)
    #error "USB Buffer Length (EPLEN) of Endpoint8 must be a multiple of 4 (word-aligned)."
  #endif
#endif
...
/*----------------------------------------------------------------------------------------------------------*/
#if (_EP9_ENABLE == 1)
  #if (_EP9_TYPR == EP_TYPE_BULK)
    #if (_EP9LEN != 8 && _EP9LEN != 16 && _EP9LEN != 32 && _EP9LEN != 64)
      #error "USB Buffer Length (EPLEN) of Endpoint9 must be 8, 16, 32, or 64 bytes under Bulk transfer."
    #endif
  #endif
  #if (_EP9LEN > 64)
    #error "USB Buffer Length (EPLEN) of Endpoint9 must be less than 64 bytes."
  #endif
  #if (_EP9LEN == 0)
    #error "USB Buffer Length (EPLEN) of Endpoint9 cannot be 0 byte."
  #endif
  #if ((_EP9LEN & 0x3) != 0x0)
    #error "USB Buffer Length (EPLEN) of Endpoint9 must be a multiple of 4 (word-aligned)."
  #endif
#endif
...
/*----------------------------------------------------------------------------------------------------------*/
  ...
  #endif
  #if (_EP8_ENABLE == 1)
    #if (_EP1_CFG_EPADR == _EP8_CFG_EPADR)
      #error "The address of Endpoint1 (EPADR) conflicts with Endpoint8."
    #endif
  #endif
  #if (_EP9_ENABLE == 1)
    #if (_EP1_CFG_EPADR == _EP9_CFG_EPADR)
      #error "The address of Endpoint1 (EPADR) conflicts with Endpoint9."
    #endif
  #endif
#endif
  ...
  #endif
  #if (_EP8_ENABLE == 1)
    #if (_EP2_CFG_EPADR == _EP8_CFG_EPADR)
      #error "The address of Endpoint2 (EPADR) conflicts with Endpoint8."
    #endif
  #endif
  #if (_EP9_ENABLE == 1)
    #if (_EP2_CFG_EPADR == _EP9_CFG_EPADR)
      #error "The address of Endpoint2 (EPADR) conflicts with Endpoint9."
    #endif
  #endif
#endif
  ...
  #endif
  #if (_EP8_ENABLE == 1)
    #if (_EP3_CFG_EPADR == _EP8_CFG_EPADR)
      #error "The address of Endpoint3 (EPADR) conflicts with Endpoint8."
    #endif
  #endif
  #if (_EP9_ENABLE == 1)
    #if (_EP3_CFG_EPADR == _EP9_CFG_EPADR)
      #error "The address of Endpoint3 (EPADR) conflicts with Endpoint9."
    #endif
  #endif
#endif
  ...
  #endif
  #if (_EP8_ENABLE == 1)
    #if (_EP4_CFG_EPADR == _EP8_CFG_EPADR)
      #error "The address of Endpoint4 (EPADR) conflicts with Endpoint8."
    #endif
  #endif
  #if (_EP9_ENABLE == 1)
    #if (_EP4_CFG_EPADR == _EP9_CFG_EPADR)
      #error "The address of Endpoint4 (EPADR) conflicts with Endpoint9."
    #endif
  #endif
#endif
  ...
  #endif
  #if (_EP8_ENABLE == 1)
    #if (_EP5_CFG_EPADR == _EP8_CFG_EPADR)
      #error "The address of Endpoint5 (EPADR) conflicts with Endpoint8."
    #endif
  #endif
  #if (_EP9_ENABLE == 1)
    #if (_EP5_CFG_EPADR == _EP9_CFG_EPADR)
      #error "The address of Endpoint5 (EPADR) conflicts with Endpoint9."
    #endif
  #endif
#endif
  ...
  #endif
  #if (_EP8_ENABLE == 1)
    #if (_EP6_CFG_EPADR == _EP8_CFG_EPADR)
      #error "The address of Endpoint6 (EPADR) conflicts with Endpoint8."
    #endif
  #endif
  #if (_EP9_ENABLE == 1)
    #if (_EP6_CFG_EPADR == _EP9_CFG_EPADR)
      #error "The address of Endpoint6 (EPADR) conflicts with Endpoint9."
    #endif
  #endif
#endif
  ...
  #endif
  #if (_EP8_ENABLE == 1)
    #if (_EP7_CFG_EPADR == _EP8_CFG_EPADR)
      #error "The address of Endpoint7 (EPADR) conflicts with Endpoint8."
    #endif
  #endif
  #if (_EP9_ENABLE == 1)
    #if (_EP7_CFG_EPADR == _EP9_CFG_EPADR)
      #error "The address of Endpoint7 (EPADR) conflicts with Endpoint9."
    #endif
  #endif
#endif
...
#if (_EP8_ENABLE == 1)
  #if (_EP8_CFG_EPADR == 0)
    #error "The address of Endpoint8 (EPADR) cannot be 0."
  #endif
  #if (_EP1_ENABLE == 1)
    #if (_EP8_CFG_EPADR == _EP1_CFG_EPADR)
      #error "The address of Endpoint8 (EPADR) conflicts with Endpoint1."
    #endif
  #endif
  #if (_EP2_ENABLE == 1)
    #if (_EP8_CFG_EPADR == _EP2_CFG_EPADR)
      #error "The address of Endpoint8 (EPADR) conflicts with Endpoint2."
    #endif
  #endif
  #if (_EP3_ENABLE == 1)
    #if (_EP8_CFG_EPADR == _EP3_CFG_EPADR)
      #error "The address of Endpoint8 (EPADR) conflicts with Endpoint3."
    #endif
  #endif
  #if (_EP4_ENABLE == 1)
    #if (_EP8_CFG_EPADR == _EP4_CFG_EPADR)
      #error "The address of Endpoint8 (EPADR) conflicts with Endpoint4."
    #endif
  #endif
  #if (_EP5_ENABLE == 1)
    #if (_EP8_CFG_EPADR == _EP5_CFG_EPADR)
      #error "The address of Endpoint8 (EPADR) conflicts with Endpoint5."
    #endif
  #endif
  #if (_EP6_ENABLE == 1)
    #if (_EP8_CFG_EPADR == _EP6_CFG_EPADR)
      #error "The address of Endpoint8 (EPADR) conflicts with Endpoint6."
    #endif
  #endif
  #if (_EP7_ENABLE == 1)
    #if (_EP8_CFG_EPADR == _EP7_CFG_EPADR)
      #error "The address of Endpoint8 (EPADR) conflicts with Endpoint7."
    #endif
  #endif
  #if (_EP9_ENABLE == 1)
    #if (_EP8_CFG_EPADR == _EP9_CFG_EPADR)
      #error "The address of Endpoint8 (EPADR) conflicts with Endpoint9."
    #endif
  #endif
#endif
...
#if (_EP9_ENABLE == 1)
  #if (_EP9_CFG_EPADR == 0)
    #error "The address of Endpoint9 (EPADR) cannot be 0."
  #endif
  #if (_EP1_ENABLE == 1)
    #if (_EP9_CFG_EPADR == _EP1_CFG_EPADR)
      #error "The address of Endpoint9 (EPADR) conflicts with Endpoint1."
    #endif
  #endif
  #if (_EP2_ENABLE == 1)
    #if (_EP9_CFG_EPADR == _EP2_CFG_EPADR)
      #error "The address of Endpoint9 (EPADR) conflicts with Endpoint2."
    #endif
  #endif
  #if (_EP3_ENABLE == 1)
    #if (_EP9_CFG_EPADR == _EP3_CFG_EPADR)
      #error "The address of Endpoint9 (EPADR) conflicts with Endpoint3."
    #endif
  #endif
  #if (_EP4_ENABLE == 1)
    #if (_EP9_CFG_EPADR == _EP4_CFG_EPADR)
      #error "The address of Endpoint9 (EPADR) conflicts with Endpoint4."
    #endif
  #endif
  #if (_EP5_ENABLE == 1)
    #if (_EP9_CFG_EPADR == _EP5_CFG_EPADR)
      #error "The address of Endpoint9 (EPADR) conflicts with Endpoint5."
    #endif
  #endif
  #if (_EP6_ENABLE == 1)
    #if (_EP9_CFG_EPADR == _EP6_CFG_EPADR)
      #error "The address of Endpoint9 (EPADR) conflicts with Endpoint6."
    #endif
  #endif
  #if (_EP7_ENABLE == 1)
    #if (_EP9_CFG_EPADR == _EP7_CFG_EPADR)
      #error "The address of Endpoint9 (EPADR) conflicts with Endpoint7."
    #endif
  #endif
  #if (_EP8_ENABLE == 1)
    #if (_EP9_CFG_EPADR == _EP8_CFG_EPADR)
      #error "The address of Endpoint9 (EPADR) conflicts with Endpoint8."
    #endif
  #endif
#endif
...
/* Check Buffer size                                                                                        */
/*----------------------------------------------------------------------------------------------------------*/
#if ((_EP0LEN_T + _EP1LEN + _EP2LEN + _EP3LEN + _EP4LEN_T + _EP5LEN_T + _EP6LEN_T + _EP7LEN_T + _EP8LEN + _EP9LEN) > 1024)
  #error "Total buffer size of Endpoint 0 ~ 7 (or 0 ~ 9) must be less than 1024 bytes."
#endif
